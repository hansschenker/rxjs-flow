...
Maintainers are responsible for clarifying acceptable behaviour and are expected to take appropriate corrective action in response to any unacceptable behaviour.
...
This Code of Conduct applies within all project spaces — GitHub issues, pull requests, discussions, and any other forum where the project is represented.

## Enforcement

Instances of unacceptable behaviour may be reported by opening an issue or contacting the maintainer directly via GitHub. All complaints will be reviewed and investigated promptly and fairly.
