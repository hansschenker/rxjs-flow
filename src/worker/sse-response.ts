...
export function prepareSseResponse(descriptor: HttpResponse, signal: AbortSignal): {
	...
	const live = createOwnedByteStream(descriptor.stream, { encode: encodeSseEvent, signal, policy: descriptor.streamPolicy });
