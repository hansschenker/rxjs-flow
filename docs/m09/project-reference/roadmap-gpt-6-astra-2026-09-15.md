...
Updated: 2026-09-23. Revision: **rxjs-flow migration r2 — Cloudflare/Hono**. Filename retained: `roadmap-gpt-6-astra-2026-09-15.md`.
...
**Implementation status, 2026-09-23:** M00 is accepted and closed by merged PR #2 at the destination baseline above. M01 is accepted/merged in PR #5 at `188f21f`. M05a is accepted/merged in PR #6 at `eeb8d29`. M02 is [accepted/merged in PR #7](m02/acceptance.md) at `7374557b6d264a9bfa572526a4f71233fc3aa24e`. M03 is [accepted/merged in PR #8](m03/acceptance.md) at `c64fda113b599ff9b0b21ae3e20aeff0c473a358`. M04 is [accepted/merged in PR #9](m04/acceptance.md) at `2b316a477600c91b3105c9e390949c29e90046d3`. M05b is [accepted/merged in PR #10](m05b/acceptance.md) at `1cfbaeca0cede3a08c90631e16cf6bdf2fa750c8`. M05c is [accepted/merged in PR #11](m05c/acceptance.md) at `d5500da407611e7856e9e67481a08e15e530aece`. Its [local Todo checkpoint](m05c/local-development.md) uses a configured Durable Object collection with attached SQLite storage, bounded admission, atomic state/metadata persistence and restart reconstruction. The built configuration leaves Todo access disabled; an explicit local Wrangler command is available. M05d is [accepted/merged in PR #12](m05d/acceptance.md) at `540faec7086bb58223c5f475db91710ac0e7389b`, completing parent M05. Its legacy [live checkpoint](m05d/local-development.md) remains available. M06 is [accepted/merged in PR #13](m06/acceptance.md) at `36d644f529d5660506d6f2aa90e90af562d01440`. The owner confirmed its [two-tab checkpoint](m06/local-development.md) and explicitly authorized M07 from that verified merge. M07 reference-app completion is [accepted and merged in PR #14](m07/acceptance.md) at `92f25680072da22d45e815ac411abd3651d002a5`, with a [local application guide](m07/local-development.md). The owner confirmed the application and explicitly authorized M08 from that verified merge. [M08 temporal tracing](m08/acceptance.md) is accepted and merged in [PR #15](https://github.com/hansschenker/rxjs-flow/pull/15) at `5362f0392b73c8cd7b8f8fb53e0857b257e55eb3`, with 1,018 tests in its recorded evidence. The owner explicitly authorized [M09 completion review](m09/acceptance.md) from that verified merge; implementation and final local verification are complete, with 1,018 tests and built/public-path/native-browser gates; acceptance review/merge is pending. Workers is the primary application/build; Node is retained as a tested local in-memory compatibility mode. A [matching Project reference copy](m09/project-reference/README.md) is prepared; upload is separate and unverified.
...
| M07 | Complete reference Todo app and forms | M04, M06 | Accepted/merged; [PR #14 at `92f2568`](m07/acceptance.md) |
| M08 | Temporal traces and adversarial integration evidence | M07 | Accepted/merged; [PR #15 at `5362f03`](m08/acceptance.md) |
| M09 | Documented API/builds, release readiness and completion review | M08 | Implemented/locally verified; [acceptance review/merge pending](m09/acceptance.md) |
...
behavior, failure/reconstruction and actual unmount/remount evidence. M07 is
accepted and merged in PR #14 at `92f25680072da22d45e815ac411abd3651d002a5`.
The owner then explicitly authorized M08 from that verified merge.
...
**Implementation checkpoint, 2026-09-20:** explicitly authorized from M07
[PR #14](https://github.com/hansschenker/rxjs-flow/pull/14), merged at
`92f25680072da22d45e815ac411abd3651d002a5`. The pristine starting tree passed
968 tests (803 Node/DOM and 165 workerd) before implementation edits.
Implementation `1e6369c9bc0e17fc99da4f512cfa98df65b10191` on
`m08/temporal-traces` passed 1,018 tests (847 Node/DOM and 171 workerd), final
native-browser development/built request parity, actual trace export and resource
checks. See the [acceptance record](m08/acceptance.md), [actual readable traces](m08/temporal-traces.md)
and [local guide](m08/local-development.md). M08 was accepted and merged in
[PR #15](https://github.com/hansschenker/rxjs-flow/pull/15) at
`5362f0392b73c8cd7b8f8fb53e0857b257e55eb3`. The M08 execution ledger remains historical
evidence; M09 was subsequently authorized from that merge.
...
**Implementation checkpoint, 2026-09-23:** explicitly authorized from M08
[PR #15](https://github.com/hansschenker/rxjs-flow/pull/15), merged at
`5362f0392b73c8cd7b8f8fb53e0857b257e55eb3`. Implementation
`cafebda2cc52b4b47a4889af08e69499d75a59bd` passed a separate clean-checkout install,
1,018 tests, typechecks, build/preview, public CRUD/live/restart delivery and a
native-browser checkpoint. Documentation is complete on `m09/completion-delivery`;
acceptance review/merge remains pending, with exact review-head CI recorded in
the PR after publication.
See the [application/API guide](m09/application-and-api.md),
[delivery guide](m09/delivery.md) and [acceptance record](m09/acceptance.md).
The Node adapter is retained as a tested local compatibility mode, with separate
in-memory state; Workers is the primary reference application/build. No remote
deployment or new package version is part of M09.
...
**Current implementation:** M09, explicitly authorized from the verified M08
merge. M00–M08 and all four M05 substeps remain accepted/merged. Complete and
review M09's documented delivery and current verification before accepting the
roadmap as complete. Merge, release and deployment remain separate decisions.
